...
// ZeroReflectionValidator interface for completely compile-time validation
type ZeroReflectionValidator interface {
	Validate() ValidationErrors
}

// Example generated validation (this would be generated by the above code)
func ExampleGeneratedValidation() string {
	return `
